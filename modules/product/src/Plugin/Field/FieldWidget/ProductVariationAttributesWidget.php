...
use Drupal\commerce_product\ProductVariationBulkCreatorInterface;
...
class ProductVariationAttributesWidget extends ProductVariationWidgetBase implements ContainerFactoryPluginInterface {
   ...
   *
   * @var \Drupal\commerce_product\ProductVariationBulkCreatorInterface
   */
  protected $creator;
   ...
   *
   * @param \Drupal\commerce_product\ProductVariationBulkCreatorInterface $creator
   ...
   *   The attribute field manager.
   */
  public function __construct(ProductVariationBulkCreatorInterface $creator, $plugin_id, $plugin_definition, FieldDefinitionInterface $field_definition, array $settings, array $third_party_settings, EntityTypeManagerInterface $entity_type_manager, EntityRepositoryInterface $entity_repository, ProductAttributeFieldManagerInterface $attribute_field_manager, $cart_manager) {
  ...
  public static function create(ContainerInterface $container, array $configuration, $plugin_id, $plugin_definition) {
    return new static(
      $container->get('commerce_product.variation_bulk_creator'),
      $plugin_id,
      $plugin_definition,
  ...
  protected function selectVariationFromUserInput(array $variations, array $user_input) {
    return $this->selectVariationFromUserInputCustom($variations, $user_input);
  ...
  protected function getAttributeInfo(ProductVariationInterface $selected_variation, array $variations) {
    return $this->getAttributeInfoCustom($selected_variation, $variations);
    $attributes = [];
   ...
   *   The selected variation.
   */
  protected function selectVariationFromUserInputCustom(array $variations, array $user_input) {
    $selected_variation = NULL;
    if (!empty($user_input['attributes']) && $trigger_name = array_search($user_input['trigger_value'], $user_input['attributes'])) {
   ...
   *   The attribute information, keyed by field name.
   */
  protected function getAttributeInfoCustom(ProductVariationInterface $selected_variation, array $variations) {
